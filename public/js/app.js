...
const packages = [
    {
        ...
        details: "Spora yeni başlıyorsanız ve sağlam bir temel oluşturmak istiyorsanız bu paket tam size göre. Temel hareketleri doğru formda öğrenecek ve gücünüzü dengeli bir şekilde artıracaksınız."
    },
    {
        id: 2,
        ...
        popular: true,
        details: "Vücut yağ oranınızı düşürerek kaslarınızı daha belirgin hale getirmeyi hedefleyin. Yoğun kardiyo ve metabolizma hızlandırıcı antrenmanlarla forma girin."
    },
    {
        id: 3,
        ...
        details: "Kas kütlenizi en üst seviyeye çıkarmak için tasarlanmış bu programla sınırlarınızı zorlayın. Profesyonel ağırlık antrenmanları ve kişiye özel beslenme stratejileri içerir."
    },
    {
        id: 4,
        ...
        details: "Kadın anatomisine ve metabolizmasına uygun olarak hazırlanan bu program, sıkılaşma ve vücut şekillendirme hedeflerinize odaklanır. Enerjinizi yükseltin ve kendinizi daha iyi hissedin."
    },
    {
        id: 5,
        name: "Online Koçluk",
        ...
        badge: "En Kapsamlı",
        details: "Nerede olursanız olun, uzman eğitmenlerimizle birebir çalışın. Tamamen size özel hazırlanan programlar ve anlık destek ile hedeflerinize daha hızlı ulaşın."
    },
    {
        id: 6,
        ...
        details: "Vücudunuzun hareket kabiliyetini artırın ve sakatlık riskini azaltın. Bu program, esnekliğinizi geliştirerek duruşunuzu düzeltmenize ve daha rahat hareket etmenize yardımcı olur."
    }
];
